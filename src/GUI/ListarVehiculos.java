...
public class ListarVehiculos extends JFrame{
	...
	public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ListarVehiculos frame = new ListarVehiculos();
    ...
    public ListarVehiculos() {
        ...
        textArea.setText(agencia.listarVehiculos2()); // ✅ Usa correctamente el método
